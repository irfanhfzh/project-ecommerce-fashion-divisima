	...
	<div class="page-top-info pb-1 pt-5">
		<div class="container">
			<div class="site-pagination">
				...
				<a href="{{ url('/detail-product/'.$item->id.'/'.$item->slug) }}" class="text-danger">{{ $item->name }}</a> /
				@endforeach
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 order-2 order-lg-1">
                    @foreach ($products as $item)	
					<form class="checkout-form" action="{{ url('/checkout-now-success/'.$item->order_id) }}" method="POST">
					@endforeach
						@csrf
