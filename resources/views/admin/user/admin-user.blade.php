...
@section('title', $title)
@section('namepage', 'Data User')

@section('content')
<div class="row">
    <div class="col-sm-6">
        <form action="{{route('admin.user-insert')}}">
            @csrf
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="display: flex">
                <a href="{{url('admin/user/edit-user/'.$user->id)}}" class="btn btn-primary btn-sm mr-1"><i class="fas fa-edit"></i>Edit</a>
                <a href="{{url('admin/user/delete/'.$user->id)}}" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i>Delete</a>
            </td>
            @empty
